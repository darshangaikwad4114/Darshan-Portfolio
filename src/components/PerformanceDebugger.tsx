...
const PerformanceDebugger: React.FC<{ enabled?: boolean }> = ({ enabled = false }) => {
  ...
  useEffect(() => {
    ...
    const getPerformanceMetrics = () => {
      ...
      if (extendedPerformance.memory) {
        setMemoryInfo({
          usedJSHeapSize: formatBytes(extendedPerformance.memory.usedJSHeapSize),
          totalJSHeapSize: formatBytes(extendedPerformance.memory.totalJSHeapSize),
        });
      }
    };
